...
class _BigPictureState extends State<BigPicture> {
  ...
  String text1 = '\nIt all has happened very quickly. Just a couple of years ago IT companies made most of their money from selling software and hardware to customers, today many of them make money from selling information about you. The data traded by companies and even governments, often to be used to track your behavior and use it against you. The most common reason for gathering user data is to use it for personalized advertisements where maybe your recent phone calls, your sudden new walking pattern and your high blood pressure may indicate that you are vulnerable to buy presents to a date.';
  String header2 = 'You are the fuel';
  String text2 = 'Several scientists and experienced debaters argue that people have to understand that their main roles on social media are not as users but as products containing valuable data to companies. The famous Silicon Valley investor Roger McNamee, who used to work for Facebook as a mentor for the founder and CEO Mark Zuckerberg, takes this one step further describing how the user data nowadays is more important as fuel for the machine learning algorithms that help Facebook create Artificial Intelligence. Every click you do is recorded and used.';
  String header3 = "It's all about the money";
  String text3 = "“Free” platforms are masters of making money out of their users’ data. They measure themselves by average revenue per user (ARPU) and most of them are steadily increasing their revenues. The revenues differ from country to country with higher revenues per user in for example Sweden. Here are some big platforms annual global ARPU from 2019:\n Google: 40.9\$/year\nAmazon: 15\$/year\nTwitter: 9.48\$/year\nFacebook: 7.37\$/year\nPintrest: 2.80\$/year\nSnapchat: 2.09\$/year\nReddit: 0.30\$/year";
