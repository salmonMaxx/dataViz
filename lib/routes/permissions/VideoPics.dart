    ...
    return new Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          ...
          new Container(
            child: template.textBoxWithPic(null, "assets/audio.jpg", "What have you recorded?", 20, "\nAn app that accesses the storage can freely use all photos, videos and audio files on your phone. This grants the app enormous privileges to understand and track their users. However, an app cannot access exactly all stored information on your phone. Metadata about your location is for example only permitted for the app that created the data in the first place to access, even with the storage permission.", 14, null)
          )
          ],
      ),
    );
